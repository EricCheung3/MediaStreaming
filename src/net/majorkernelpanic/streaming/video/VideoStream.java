...
public abstract class VideoStream extends MediaStream {
	...
	protected void encodeWithMediaCodecMethod1() throws RuntimeException, IOException {
		...
		int size = previewSize.width * previewSize.height * android.graphics.ImageFormat.getBitsPerPixel(previewFormat) / 8;
	...
	private void measureFramerate() {
		...
		try {
			...
			if (mSettings != null) {
				...
				editor.putInt(PREF_PREFIX + "fps" + mRequestedQuality.framerate + "," + mCameraImageFormat + "," + mRequestedQuality.resX + mRequestedQuality.resY,
						mQuality.framerate);
				editor.commit();
			}
		} catch (InterruptedException e) {
